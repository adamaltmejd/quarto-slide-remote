      ...
      switch (cmd) {
        ...
        case "goto": {
          ...
          if (typeof a.h === "number")
            this.reveal.slide(a.h, a.v ?? 0, a.f);
          break;
        }
        case "black":
...
`;
  ...
  class Overlay {
    ...
    `;
      const closeBtn = this.el.querySelector(".sr-overlay__close");
      ...
      this.statusEl = this.el.querySelector(".sr-overlay__status");
      this.peerEl = this.el.querySelector(".sr-overlay__peer");
      this.codeEl = this.el.querySelector(".sr-overlay__code");
    }
    open(joinUrl, roomId) {
    ...
    activate() {
      ...
      this.client = new Client(this.cfg.workerUrl, this.reveal, {
        ...
        onStatus: (text) => {
          ...
          if (text === "connected")
            this.badge?.setState("connected", "paired");
          else if (text === "disconnected")
            this.badge?.setState("disconnected", "offline");
          else
            this.badge?.setState("reconnecting", text);
        },
